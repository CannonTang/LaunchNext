...
final class AppStore: ObservableObject {
    ...
    enum ScrollPagingInputSource: String, CaseIterable, Codable, Identifiable {
        case vertical
        case horizontal
        case automatic
        ...
        var localizationKey: LocalizationKey {
            switch self {
            case .vertical: return .scrollPagingInputVertical
            case .horizontal: return .scrollPagingInputHorizontal
            case .automatic: return .scrollPagingInputAutomatic
            }
        }
    }
    ...
    static let scrollPagingInputSourceKey = "scrollPagingInputSource"
    ...
    private static func loadScrollPagingInputSource() -> ScrollPagingInputSource {
        if let raw = UserDefaults.standard.string(forKey: scrollPagingInputSourceKey),
           let source = ScrollPagingInputSource(rawValue: raw) {
            return source
        }
        return .vertical
    }
    ...
    private static func writeDefaultAppearancePreferences(to defaults: UserDefaults) {
        ...
        defaults.set(ScrollPagingInputSource.vertical.rawValue, forKey: Self.scrollPagingInputSourceKey)
    ...
    private func reloadAppearancePreferencesFromDefaults() {
        ...
        scrollPagingInputSource = Self.loadScrollPagingInputSource()
    ...
    @Published var scrollPagingInputSource: ScrollPagingInputSource = AppStore.loadScrollPagingInputSource() {
        didSet {
            guard scrollPagingInputSource != oldValue else { return }
            UserDefaults.standard.set(scrollPagingInputSource.rawValue, forKey: Self.scrollPagingInputSourceKey)
        }
    }
    ...
    func resetAppearanceSettings() {
        ...
        let keysToClear: [String] = [
            ...
            Self.scrollPagingInputSourceKey,
