...
extension CAGridView {
    ...
    private func primaryScrollDelta(deltaX: CGFloat, deltaY: CGFloat) -> CGFloat {
    ...
    func handleScrollWheel(with event: NSEvent) {
        ...
        let deltaX = axes.x
        let deltaY = axes.y
        let delta = primaryScrollDelta(deltaX: deltaX, deltaY: deltaY)
        ...
        case .ended, .cancelled:
            ...
            let velocity = primaryScrollDelta(deltaX: deltaX, deltaY: deltaY) * sensitivityScale
